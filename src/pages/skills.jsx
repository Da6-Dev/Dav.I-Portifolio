...
// O Card de Habilidade agora não tem descrição, simplificando-o.
// Iremos adicionar um tooltip no futuro se desejado.
...
function Skills() {
    ...
    // Os dados das skills agora são definidos dentro do componente
    // para acessar a função `t()` para as descrições e categorias.
    const skillsData = {
        [t('skills.frontend')]: [
